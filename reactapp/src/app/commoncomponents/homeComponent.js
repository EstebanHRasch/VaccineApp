...
//export default class Home extends React.Component{
    ...
    render() {
        ...
        return(
            <div className={"loadimage form"} style={{backgroundImage: "url(/images/vaccine_pic.png)"}}>
            {/* <p>{this.state.name}</p> */}
            {/* <img src={"./images/hm_pic4.jpg"} /> */}
            {/* {this.state.Title} */}
            <b className="feature">{"Homepage for VaccineApp :"}</b>
            <ul>                     
                <li>Sign up patients</li>
                <li>Sign up admins</li>
                <li>Add vaccines to store</li>
                <li>Register for your vaccine</li>
                <li>Approve/Reject vaccine orders</li>
            </ul>
